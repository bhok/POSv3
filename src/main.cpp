...
#if defined(NDEBUG)
# error "SwagBucks cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 8 * 60; // 8 hours
...
const string strMessageMagic = "SwagBucks Signed Message:\n";
...
{
    RenameThread("swagbucks-loadblk");
